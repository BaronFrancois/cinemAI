...
try {
  ...
  await page.locator('.panes-host > [data-tab="projet"] .h1', { hasText: "Nouveau projet" }).waitFor();
  ...
  await page.locator('.panes-host > [data-tab="projet"] .h1', { hasText: "Contrat UI" }).waitFor();
  ...
  await page.locator('.rail-item[data-tab="personnages"]').click();
  await page.locator('.panes-host > [data-tab="personnages"]', { hasText: "Asset test" }).waitFor();
  await page.locator('.rail-item[data-tab="script"]').click();
  await page.locator('.panes-host > [data-tab="script"]', { hasText: "2 s" }).waitFor();
  await page.locator('.rail-item[data-tab="production"]').click();
